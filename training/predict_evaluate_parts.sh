...
DATASET=558
DATASET_NAME=Dataset558_BCA_2d_parts
...
python training/evaluate.py --gt-folder $nnUNet_eval/$DATASET_NAME/labelsTs --pred-folder $nnUNet_predictions/${DATASET_NAME}/test --dataset parts --results-folder results --ignore-label 255
...
python training/evaluate.py --gt-folder $nnUNet_eval/$DATASET_NAME/labelsTs --pred-folder $nnUNet_predictions/${DATASET_NAME}/test_pp --dataset parts --results-folder results --ignore-label 255
